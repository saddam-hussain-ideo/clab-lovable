...
export const TokenMetricsDisplay = ({ totalSupply, tokenType, currentStage, isLoading }: TokenMetricsDisplayProps) => {
  // Debug output to console
  useEffect(() => {
    console.log("TokenMetricsDisplay rendering with:", { totalSupply, tokenType, currentStage, isLoading });
  }, [totalSupply, tokenType, currentStage, isLoading]);
